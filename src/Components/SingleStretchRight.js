...
import { StretchBlockSingleRight, LandingContainer } from "./Styled";
import Github from "../Assets/github.png";
import Linkedin from "../Assets/linkedin.png";
import Row from "react-bootstrap/Row";
import Col from "react-bootstrap/Col";

const SingleStretchRight = (props) => {
  ...
  // single right stretch block
  return (
    <StretchBlockSingleRight display={blockContact} scrollStyle={scrollContact}>
      {contentReturn()}
    </StretchBlockSingleRight>
  );
};

export default SingleStretchRight;
